...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "Quality Control Room"),
    React.createElement("p", null, "Inspection posture, hold or release decisions, and CAPA visibility across operational flows."),
    React.createElement(
      "p",
      null,
