...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/quality-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-quality-core:");
...
console.log("Documentation check passed for gutu-plugin-quality-core.");
